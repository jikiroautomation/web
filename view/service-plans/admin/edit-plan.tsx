...
const EditPlanView = ({ serviceId, planId }: EditPlanViewProps) => {
    ...
    <div className="space-y-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Update pricing plan details for {service.name}
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update the information for this pricing plan
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Sort Order, Popular, and Active Status */}

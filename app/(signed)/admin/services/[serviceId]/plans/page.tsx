...
import ServicePlansView from "@/view/service-plans";

export const metadata: Metadata = {
  title: "Service Plans Management - Admin | JIKIRO",
  description: "Manage pricing plans and service tiers for individual services. Admin interface for service plan management on JIKIRO.",

...
export const metadata: Metadata = {
  title: "Sign Up - JIKIRO",
  description:
    "Sign up for your JIKIRO account to access your dashboard and manage your professional services.",
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-2">
                Selamat Datang di JIKIRO
              </h1>
              <p className="text-gray-600 text-sm dark:text-gray-300">
                Daftar dan masuk ke akun JIKIRO Anda
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="border-t border-gray-400 dark:border-gray-600 pt-6">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                © {new Date().getFullYear()} JIKIRO. All rights reserved.
              </p>
              <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
                JIKIRO adalah platform yang didukung AI
              </p>
            </div>
          </div>
        </footer>
